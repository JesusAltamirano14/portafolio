    ...
    <div className={scroll?'navbar navbar-active':'navbar'}>
        ...
        <div className={hamburger?'navbar__container-all navbar__container-all-active':'navbar__container-all'}>
            ...
            <div className='navbar__buttons'>
                <a href="https://www.google.com.pe" target="_blank" rel="noreferrer" className="navbar__buttons__git">{null}</a>
                <a href="https://www.google.com.pe" target="_blank" rel="noreferrer" className="navbar__buttons__cv">{null}</a>
                <a href="#contact" className="navbar__buttons__contact">
                    <span className='navbar__buttons__contact__me'>Contact me</span>
                </a>
            </div>
        </div>
    </div>
